...
-   **Flexible File Organization**: Customize the output directory structure to suit your preferences (e.g., sort by year first or by session first).
...
Before running the script, you must set up your files in a specific way. The script requires a helper file called `syllabus.csv` to be in the **same directory** as the Python script itself.
...
| `-fs`, `--file_structure` | `<choice>`          | No        | Defines the output directory structure. See the dedicated section below for details. Default is `year_month_paper`.                      |

### `--file_structure` Options

This argument gives you control over how the downloaded files are organized. All files will be placed inside the main output directory, `CIE_OUT/`.

-   `year_month_paper` (**Default**): `CIE_OUT/Subject-Code/YYYY/Month-Session/Paper P/files...`
    -   *Example*: `CIE_OUT/Mathematics-9709/2023/May-June/Paper 1/9709_s23_qp_11.pdf`

-   `month_year_paper`: `CIE_OUT/Subject-Code/Month-Session/YYYY/Paper P/files...`
    -   *Example*: `CIE_OUT/Mathematics-9709/May-June/2023/Paper 1/9709_s23_qp_11.pdf`

-   `year_month`: `CIE_OUT/Subject-Code/YYYY/Month-Session/files...` (No separate 'Paper' folder)
    -   *Example*: `CIE_OUT/Mathematics-9709/2023/May-June/9709_s23_qp_11.pdf`

-   `month_year`: `CIE_OUT/Subject-Code/Month-Session/YYYY/files...` (No separate 'Paper' folder)
    -   *Example*: `CIE_OUT/Mathematics-9709/May-June/2023/9709_s23_qp_11.pdf`
